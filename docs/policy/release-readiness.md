...
records evidence current through 2026-08-08. Performance measurements used
...
signatures, and the repository compatibility suite have evidence. The exact
formal public performance rerun is now recorded for the measured revision
below. The published ten-case error comparison has not received independent
third-party review. Its machine-readable
[`R001` status](../evidence/error-ux-review-status-v1.json) is
...
R001: `HOLD` — [`awaiting_independent_review`](../evidence/error-ux-review-status-v1.json).
...
[`claims.yml`](../registry/claims.yml) under the [comparison policy](comparison-policy.md).
...
| Project | Cold generation ratio | Reuse time ratio | Reuse allocations ratio | New-instance time ratio | New-instance allocations ratio | Generated bytes ratio |
|---|---:|---:|---:|---:|---:|---:|
...
The complete formal result is [`2026-08-08-8c9cef999d09-ruby-4.0.0-arm64-darwin24.json`](../../benchmark/results/public/2026-08-08-8c9cef999d09-ruby-4.0.0-arm64-darwin24.json). It records ten alternating isolated runs per implementation and scenario, 50 warm-up workloads, 250 measured workloads, five behavior probes, 10,000 bootstrap samples, exact public checkout revisions, and equivalent result and result-sequence digests.
<!-- comparative-claim:racc-public-performance-2026-08-08:end -->
...
[`error-ux.md`](../evidence/error-ux.md) and its versioned JSON publish the same ten
...
[`independent rubric`](../evidence/error-ux-review-rubric-v1.md), generate a draft with the
