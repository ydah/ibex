---
title: Preview and Experimental maturity
description: Track feature maturity, activation boundaries, evidence, and promotion rules.
---

# Preview and Experimental maturity audit

[`maturity.yml`](../registry/maturity.yml) and the validator-owned commit authorities in
