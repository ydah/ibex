# ADR 0041: Collect frontend diagnostics with bounded boundary recovery
...
Lossless source documents from ADR 0040 provide exact spans and opaque action/heredoc segments. They do not by themselves define
