# ADR 0036: Preserve grammar text in a lossless source document
...
decision. ADR 0039 later uses segment positions to add nullable documentation to `AST::Rule` and reserved Grammar IR v2 fields
...
- Formatting, includes, and LSP work can share one source contract without altering grammar meaning. ADR 0039 completes
