...
[`error-ux-round2-v1.json`](round2-v1.json), validated by
...
[`review status registry`](round2-review-status-v1.json) and
...
[`records workflow`](round2-reviews/v1/records/README.md).
