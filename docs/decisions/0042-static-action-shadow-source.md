# ADR 0042: Generate non-executable semantic-action shadow source
...
written before ADR 0042 remain loadable and fall back to `untyped`. Normalization records the eliminated production LHS semantic
