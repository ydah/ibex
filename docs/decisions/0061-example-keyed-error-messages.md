# ADR 0061: Example-keyed syntax error messages
...
ADR 0029 attached custom syntax messages to numeric LR states. That made the
...
emits v2. This preserves the stability promise made by ADR 0029 without keeping
