# 0034: Expose versioned, selectable conflict explanations
...
`Ibex::LALR::Counterexample`. It supports all deterministic construction algorithms, default and extended frontend modes, optional
