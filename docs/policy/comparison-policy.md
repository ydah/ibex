---
title: Comparative claim policy
description: Define the evidence, wording, and publication rules for comparisons with other parser tools.
---

# Comparative claim policy

This policy defines when Ibex documentation may compare Ibex with another
parser tool. The machine-readable registry is [`claims.yml`](../registry/claims.yml), and
