---
title: Runtime ABI evolution
description: Evolve serialized parser inputs, generated tables, and runtime APIs under explicit compatibility rules.
---
...
runtime_paths:
  ...
  - docs/records/test-interactions.md
