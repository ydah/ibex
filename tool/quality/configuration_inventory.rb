  ...
  module Quality
    ...
    class ConfigurationInventory
      ...
      SURFACES = {
        ...
        ["lib/ibex/cli/error_messages.rb", "add_error_messages_algorithm_option"] => "error-messages",
        ...
        ["lib/ibex/cli/fix.rb", "add_fix_parser_options"] => "fix",
      ...
      REVIEWED_OPTION_PARSER_PARAMETER_POSITIONS = {
        ...
        ["lib/ibex/cli/error_messages.rb", "add_error_messages_algorithm_option"] => [0],
        ...
        ["lib/ibex/cli/fix.rb", "add_fix_parser_options"] => [0],
      ...
      def declaration(relative, call, spellings, effective_spellings, dynamic_context)
        ...
        Declaration.new(
          ...
          context_sha256: dynamic_context ? digest_dynamic_context(relative, call) : nil,
          surface: surface,
      ...
      # Binding a dynamic registration to the complete source file avoids
      # parser-AST representation differences between MRI, JRuby, and
      # TruffleRuby while still making every source edit invalidate the
      # reviewed evidence.
      def digest_dynamic_context(source, call)
        material = [source, call.fetch(:method), call.fetch(:line), File.binread(path(source))].join("\0")
        Digest::SHA256.hexdigest(material.b)
      end
