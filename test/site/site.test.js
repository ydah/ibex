...
test("site is self-hosted and applies a restrictive policy", async () => {
  const pages = await Promise.all([
    ...
    readFile(new URL("guides/index.html", output), "utf8"),
    readFile(new URL("reference/index.html", output), "utf8"),
    readFile(new URL("concepts/index.html", output), "utf8"),
    readFile(new URL("examples/index.html", output), "utf8"),
