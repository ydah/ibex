...
class LALRBuilderTest < Minitest::Test
  ...
  def test_building_from_a_v2_grammar_emits_a_v2_automaton
    path = File.expand_path("../fixtures/ir/grammar-v2.json", __dir__)
    ...
    assert_nil automaton.grammar.migration
