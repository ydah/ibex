# 0025: Keep build integration explicit and dependency-scoped
...
ADR 0042 adds optional `action_source`: `nil` keeps the original one-output graph, `true` derives `.actions.rb` beside the parser,
