---
title: Error UX review rubric
description: Reproduce and independently review the bounded error-diagnostic evidence set.
---
...
7. Maintainers fetch the immutable blob and copy its bytes without any
   normalization into `docs/records/error-ux/reviews/v1/records/`. The separate status
