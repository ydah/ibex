---
title: Data-only parser table artifacts
description: Inspect and verify parser table data without loading generated Ruby.
---
...
This does not extend the claims of [`ibex verify`](../policy/verifier-trust-boundary.md).
