---
title: Public workload registry
description: Identify public workloads, provenance, measurements, known problems, and benchmark eligibility.
---

# Public workload and problem registry

[`workloads.yml`](../registry/workloads.yml) is the machine-readable authority for workload
...
The H005 [construction profile](../records/profiles/construction-profiling.md) consumes these exact
