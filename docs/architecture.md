...
`Serialize.load` and `Validator.validate` accept all three versions and preserve the loaded shape. Declaration-free source
...
## Automaton IR versions 1, 2, and 3
...
contracts for all three versions live under `schema/`; see
