...
class MaturityTest < Minitest::Test
  ...
  def test_review_date_covers_the_reviewed_commit_in_its_recorded_timezone
    ...
    assert_equal Date.new(2026, 8, 10), Ibex::Quality::Maturity.commit_date(ROOT, revision)
  ...
  def test_rejects_stale_incomplete_or_unknown_issue_audits
    ...
    audit["checked_at"] = "2026-08-11"
    audit["fresh_until"] = "2026-09-05"
    assert_error(changed, "checked_at cannot follow the maturity review", today: Date.new(2026, 8, 11))
