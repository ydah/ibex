...
[`blind-study-v1.json`](reviews/v1/blind-study-v1.json)
...
The [record instructions](reviews/v1/records/README.md)
...
in the [status registry](review-status-v1.json). Once at
