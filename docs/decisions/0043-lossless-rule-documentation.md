# ADR 0043: Attach rule documentation from lossless comments

- Status: Accepted
- Date: 2026-07-25
- Supersedes: the rule-documentation boundary in ADR 0035
...
Rule documentation must therefore correlate the generated semantic AST with ADR 0040's lossless segments without parsing source
