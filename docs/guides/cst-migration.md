---
title: CST migration
description: Migrate legacy parser tables and applications to the current Red/Green CST contract.
---
...
Experimental. See the [CST guide](../concepts/cst.md) for examples and the incremental
action contract.
