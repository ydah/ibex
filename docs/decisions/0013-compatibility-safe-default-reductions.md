# 0013: Compatibility-safe default reductions

- Status: Accepted
- Date: 2026-07-22
- Supersedes: [ADR 0005](0005-automaton-ir-and-default-actions.md)

## Context

Automaton IR already reserves `default_action`, but ADR 0005 left it null because an ordinary yacc-style default reduction can
...
round-trippable Automaton IR contract established by ADR 0005.
