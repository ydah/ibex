# ADR 0074: Name fragment composition with import
...
ADR 0042 implemented the complete secure fragment-composition boundary under an `include` spelling. The v1.0 feature contract
...
cycle diagnostics, immutable resolution, source provenance, CLI behavior, and build dependencies defined by ADR 0042.
