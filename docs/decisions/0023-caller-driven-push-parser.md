# 0023: Add a caller-driven push parser lifecycle
...
The optional location matches the pull token-source contract from ADR 0024; `finish(location:)` can locate EOF errors. Semantic
